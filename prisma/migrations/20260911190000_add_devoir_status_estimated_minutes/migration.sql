...
INSERT INTO "new_Devoir" ("aRendre", "createdAt", "description", "done", "echeance", "id", "plannedStartTime", "plannedWeekday", "subjectId", "userId") SELECT "aRendre", "createdAt", "description", "done", "echeance", "id", "plannedStartTime", "plannedWeekday", "subjectId", "userId" FROM "Devoir";
DROP TABLE "Devoir";
