...
INSERT INTO "new_Devoir" ("id", "userId", "subjectId", "description", "aRendre", "echeance", "echeanceTime", "done", "createdAt", "status", "estimatedMinutes")
SELECT "id", "userId", "subjectId", "description", "aRendre", "echeance", "plannedStartTime", "done", "createdAt", "status", "estimatedMinutes" FROM "Devoir";
DROP TABLE "Devoir";
